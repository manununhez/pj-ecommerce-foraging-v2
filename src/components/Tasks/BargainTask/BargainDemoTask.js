...
export default function BargainDemoTask(props) {
    ...
    const list = [{
        storeNumber: 1, bargainsNumber: 4, delay: 15, products: [
            ...
            { productNumber: 2, isBargain: false, oldPrice: 131, newPrice: 94.32, discount: 0.28, numOfStars: 6, img: "https://api.swps-pjatk-experiment.pl/v3/img/17picture.jpg" },
            ...
            { productNumber: 6, isBargain: false, oldPrice: 123, newPrice: 83.64, discount: 0.32, numOfStars: 5, img: "https://api.swps-pjatk-experiment.pl/v3/img/7picture.jpg" },
        ...
        storeNumber: 2, bargainsNumber: 15, delay: 15, products: [
            ...
            { productNumber: 6, isBargain: false, oldPrice: 176, newPrice: 126.72, discount: 0.28, numOfStars: 5, img: "https://api.swps-pjatk-experiment.pl/v3/img/21electron_picture.jpg" },
